                    ...
                    <div className="auto-container">
                        ...
                        <div className="row clearfix">
                            ...
                            <div className="course-block-four col-lg-6 col-md-12 col-sm-12">
                                <div className="inner-box">
                                    <div className="image">
                                        <a href="course-detail.html"><img src="images/resource/course-31.jpg" alt="" /></a>
                                        <div className="tag">free</div>
                                    </div>
                                    <div className="content">
                                        <h4><a href="course-detail.html">Java Programming Software Developers</a></h4>
                                        <div className="uni-name">University of Roehampton</div>
                                        <div className="rating">
                                            <span className="fa fa-star"></span>
                                            <span className="fa fa-star"></span>
                                    ...
                                    <div className="overlay-content-box">
                                        ...
                                        <div className="clearfix">
                                            <div className="price">$49 <span>$100.99</span></div>
                                            <div className="hovers">11.5 total hours . All Levels</div>
                                        </div>
                                        <div className="text">There are many variations of Lorem Ipsum available, but the majority have suffered.</div>
                                        <ul className="lists">
                            ...
                            <div className="course-block-four col-lg-6 col-md-12 col-sm-12">
                                <div className="inner-box">
                                    <div className="image">
                                        <a href="course-detail.html"><img src="images/resource/course-33.jpg" alt="" /></a>
                                        <div className="tag">free</div>
                                    </div>
                                    <div className="content">
                                        <h4><a href="course-detail.html">Java Programming Software Developers</a></h4>
